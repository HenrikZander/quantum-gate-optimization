...
def getGateFidelity(x,N=2,wantiSWAP=False,wantCZ=False,wantI=False):
    ...
    for i in timeIndexes:
        ...
        for j in range(len(c)):
            c[j] = evolvedStates[j][timeIndex]
        
        # Calculate U_rf:
        U_rf = getRFUnitary(HEB[0] - U_e*HBBComps[1]*U_e.dag(), ts[timeIndex])
