...
xName = 'x_210715_CZ_1_4lvl' # Preferred if solution is listed in solutions.json
...
def main():
    ...
    # test()
    # getRobustnessPlot(xName=xName, wantiSWAP=True, checkOmegaPhi=True, checkOpTime=True, nPointsList=[9], useSavedPlot=True)
